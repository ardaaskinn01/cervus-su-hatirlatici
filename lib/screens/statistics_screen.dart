            ...
            children: [
              ...
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: isHit ? const Color(0xFF10B981) : const Color(0xFFF8FAFC),
                  border: Border.all(color: isHit ? Colors.transparent : const Color(0xFFE2E8F0), width: 1.5),
                  boxShadow: isHit ? [BoxShadow(color: const Color(0xFF10B981).withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 4))] : null,
                ),
